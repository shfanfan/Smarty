...
#if HW_TYPE == HW_ARDUINO_UNO

// pins for nRF24l01+
#define CE_PIN 9
#define CS_PIN 10

#elif HW_TYPE == HW_DAVIDUINO

// pins for nRF24l01+
#define CE_PIN 10
#define CS_PIN 8

#elif HW_TYPE == HW_ARDUINO_NANO

#elif HW_TYPE == HW_ARDUINO_ETH

#elif HW_TYPE == HW_SMARTY_M328_V1

#elif HW_TYPE == HW_SMARTY_T84_V1
